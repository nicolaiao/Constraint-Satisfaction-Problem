...
class CSP:
    #defining global variables for iterating purposes
    def __init__(self):
        #defining global variables for iterating purposes, using unused letters
        self.z = 0
        self.failCount = 0
    ...
    def backtrack(self, assignment):
        ...
        """
        #incrementing every function call
        self.z += 1
        ...
        order_domain = assignment[unassigned]
        
        for value in order_domain:
    ...
    def revise(self, assignment, i, j):
        ...
        for a in assignment[i]:
            ...
            for b in assignment[j]:
                if (a, b) in self.constraints[i][j]:
                    switch = True
            if switch:
                return revised
...
def main():
    for filename in filenames:
        ...
        print("Bactrack function called", sudoku.z, "times")
        print("Failed", sudoku.failCount, "times")
